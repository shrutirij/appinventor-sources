...
goog.provide('Blockly.MiniBubble');
 ...
 * @private
 */
Blockly.MiniBubble.unbindDragEvents_ = function() {
 ...
 * @private
 */
Blockly.MiniBubble.prototype.rendered_ = false;

/**
 * Absolute X coordinate of anchor point.
 * @private
 */
Blockly.MiniBubble.prototype.anchorX_ = 0;

/**
 * Absolute Y coordinate of anchor point.
 * @private
 */
Blockly.MiniBubble.prototype.anchorY_ = 0;
 ...
 * @private
 */
Blockly.MiniBubble.prototype.relativeLeft_ = 0;

/**
 * Relative Y coordinate of bubble with respect to the anchor's centre.
 * @private
 */
Blockly.MiniBubble.prototype.relativeTop_ = 0;

/**
 * Width of bubble.
 * @private
 */
Blockly.MiniBubble.prototype.width_ = 0;

/**
 * Height of bubble.
 * @private
 */
Blockly.MiniBubble.prototype.height_ = 0;

/**
 * Automatically position and reposition the bubble.
 * @private
 */
Blockly.MiniBubble.prototype.autoLayout_ = true;
 ...
 * @private
 */
Blockly.MiniBubble.prototype.createDom_ = function(content, hasResize) {
 ...
 * @private
 */
Blockly.MiniBubble.prototype.bubbleMouseDown_ = function(e) {
    this.promote_();
 ...
 * @private
 */
Blockly.MiniBubble.prototype.bubbleMouseMove_ = function(e) {
 ...
 * @private
 */
Blockly.MiniBubble.prototype.resizeMouseDown_ = function(e) {
    this.promote_();
    Blockly.Bubble.unbindDragEvents_();
    if (Blockly.isRightButton(e)) {
        // Right-click.
 ...
 * @private
 */
Blockly.MiniBubble.prototype.resizeMouseMove_ = function(e) {
    this.autoLayout_ = false;
 ...
 */
Blockly.MiniBubble.prototype.registerResizeEvent = function(thisObject, callback) {
 ...
 * @private
 */
Blockly.MiniBubble.prototype.promote_ = function() {
 ...
 */
Blockly.MiniBubble.prototype.setAnchorLocation = function(x, y) {
    this.anchorX_ = x;
    this.anchorY_ = y;
    if (this.rendered_) {
        this.positionBubble_();
 ...
 * @private
 */
Blockly.MiniBubble.prototype.layoutBubble_ = function() {
 ...
 * @private
 */
Blockly.MiniBubble.prototype.positionBubble_ = function() {
    var left;
    if (Blockly.RTL) {
 ...
 */
Blockly.MiniBubble.prototype.getBubbleSize = function() {
 ...
 */
Blockly.MiniBubble.prototype.setBubbleSize = function(width, height) {
 ...
 * @private
 */
Blockly.MiniBubble.prototype.renderArrow_ = function() {
    var steps = [];
 ...
 */
Blockly.MiniBubble.prototype.setColour = function(hexColour) {
 ...
 */
Blockly.MiniBubble.prototype.dispose = function() {
    Blockly.Bubble.unbindDragEvents_();
