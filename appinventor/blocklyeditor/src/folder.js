 ...
 * @param {!Blockly.Workspace} workspace The block's workspace.
 * @return {Blockly.Folder} The found block, or null if not found.
 */
Blockly.Folder.getById = function(id, workspace) {
    if (Blockly.Realtime.isEnabled()) {
 ...
 * @type {Blockly.FolderSvg}
 * @private
 */
Blockly.Folder.prototype.svg_ = null;

/**
 * Block's mutator icon (if any).
 * @type {Blockly.Mutator}
 */
Blockly.Folder.prototype.mutator = null;

/**
 * Block's comment icon (if any).
 * @type {Blockly.Comment}
 */
Blockly.Folder.prototype.comment = null;

/**
 * Block's warning icon (if any).
 * @type {Blockly.Warning}
 */
Blockly.Folder.prototype.warning = null;

/**
 * Block's error icon (if any).
 * @type {Blockly.ErrorIcon}
 */
Blockly.Folder.prototype.errorIcon = null;
 ...
 */
Blockly.Folder.prototype.getSvgRoot = function() {
 ...
 */
Blockly.Folder.prototype.select = function() {
 ...
 */
Blockly.Folder.prototype.unselect = function() {
    goog.asserts.assertObject(this.svg_, 'Block is not rendered.');
 ...
 */
Blockly.Folder.prototype.dispose = function(healStack, animate,
 ...
 */
Blockly.Folder.prototype.unplug = function(healStack, bump) {
 ...
 */
Blockly.Folder.prototype.getRelativeToSurfaceXY = function() {
    var x = 0;
    var y = 0;
    if (this.svg_) {
 ...
 */
Blockly.Folder.prototype.moveBy = function(dx, dy) {
 ...
 */
Blockly.Folder.prototype.getHeightWidth = function() {
 ...
 */
Blockly.Folder.prototype.getHeightWidthNeil = function() {
 ...
 * @private
 */
Blockly.Folder.prototype.onMouseDown_ = function(e) {
    if (this.isInFlyout) {
        return;
    }
    ...
    if (Blockly.isRightButton(e)) {
        ...
        Blockly.Folder.dragMode_ = 1;
        Blockly.Folder.onMouseUpWrapper_ = Blockly.bindEvent_(document,
            'mouseup', this, this.onMouseUp_);
        Blockly.Folder.onMouseMoveWrapper_ = Blockly.bindEvent_(document,
 ...
 * @private
 */
Blockly.Folder.prototype.showHelp_ = function() {
 ...
 * @return {!Blockly.Folder} The duplicate.
 * @private
 */
Blockly.Folder.prototype.duplicate_ = function() {
    ...
    var newFolder = Blockly.Xml.domToBlock(
 ...
 * @private
 */
Blockly.Folder.prototype.showContextMenu_ = function(e) {
 ...
 * @private
 */
Blockly.Folder.prototype.getConnections_ = function(all) {
    var myConnections = [];
 ...
 * @private
 */
Blockly.Folder.prototype.moveConnections_ = function(dx, dy) {
    if (!this.rendered) {
 ...
 * @private
 */
Blockly.Folder.prototype.setDragging_ = function(adding) {
    if (adding) {
 ...
 * @private
 */
Blockly.Folder.prototype.onMouseMove_ = function(e) {
    var this_ = this;
    Blockly.doCommand(function() {
        ...
        if (Blockly.Folder.dragMode_ == 1) {
            // Still dragging within the sticky DRAG_RADIUS.
            var dr = Math.sqrt(Math.pow(dx, 2) + Math.pow(dy, 2));
            if (dr > Blockly.DRAG_RADIUS) {
                // Switch to unrestricted dragging.
                Blockly.Folder.dragMode_ = 2;
 ...
 * @return {Blockly.Folder} The block that holds the current block.
 */
Blockly.Folder.prototype.getParent = function() {
 ...
 * @return {Blockly.Folder} The block that surrounds the current block.
 */
Blockly.Folder.prototype.getSurroundParent = function() {
    var block = this;
    while (true) {
        do {
            var prevBlock = block;
 ...
 * @return {Blockly.Folder} The next statement block or null.
 */
Blockly.Folder.prototype.getNextBlock = function() {
 ...
 * @return {!Array.<!Blockly.Folder>} Array of blocks.
 */
Blockly.Folder.prototype.getChildren = function() {
 ...
 */
Blockly.Folder.prototype.isDeletable = function() {
 ...
 */
Blockly.Folder.prototype.setDeletable = function(deletable) {
 ...
 */
Blockly.Folder.prototype.isMovable = function() {
 ...
 */
Blockly.Folder.prototype.setMovable = function(movable) {
 ...
 */
Blockly.Folder.prototype.isEditable = function() {
 ...
 */
Blockly.Folder.prototype.setEditable = function(editable) {
 ...
 */
Blockly.Folder.prototype.setHelpUrl = function(url) {
    this.helpUrl = url;
};
 ...
 */
Blockly.Folder.prototype.getColour = function() {
 ...
 * @private
 */
Blockly.Folder.prototype.getField_ = function(name) {
    for (var x = 0, input; input = this.inputList[x]; x++) {
        for (var y = 0, field; field = input.fieldRow[y]; y++) {
            if (field.name === name) {
                return field;
 ...
 */
Blockly.Folder.prototype.getFieldValue = function(name) {
 ...
 */
Blockly.Folder.prototype.getTitleValue = function(name) {
 ...
 * @deprecated December 2013
 */
Blockly.Folder.prototype.setTitleValue = function(newValue, name) {
 ...
 */
Blockly.Folder.prototype.setTooltip = function(newTip) {
    this.tooltip = newTip;
};
 ...
 */
Blockly.Folder.prototype.setPreviousStatement = function(newBoolean, opt_check) {
    if (this.previousConnection) {
 ...
 *     statement types.  Null or undefined if any type could be connected.
 */
Blockly.Folder.prototype.setNextStatement = function(newBoolean, opt_check) {
    if (this.nextConnection) {
 ...
 *     (e.g. variable get).
 */
Blockly.Folder.prototype.setOutput = function(newBoolean, opt_check) {
    if (this.outputConnection) {
 ...
 *     output.
 */
Blockly.Folder.prototype.changeOutput = function(check) {
    goog.asserts.assert(this.outputConnection,
 ...
 */
Blockly.Folder.prototype.setInputsInline = function(newBoolean) {
 ...
 */
Blockly.Folder.prototype.setDisabled = function(disabled) {
 ...
 */
Blockly.Folder.prototype.getInheritedDisabled = function() {
    var block = this;
    while (true) {
 ...
 */
Blockly.Folder.prototype.isCollapsed = function() {
 ...
 */
Blockly.Folder.prototype.setCollapsed = function(collapsed) {
 ...
 */
Blockly.Folder.prototype.toString = function(opt_maxLength) {
    var text = [];
    for (var x = 0, input; input = this.inputList[x]; x++) {
        for (var y = 0, field; field = input.fieldRow[y]; y++) {
 ...
 */
Blockly.Folder.prototype.appendValueInput = function(name) {
 ...
 * @return {!Blockly.Input} The input object created.
 */
Blockly.Folder.prototype.appendStatementInput = function(name) {
...
Blockly.Folder.prototype.appendIndentedValueInput = function(name) {
 ...
 *     in msg).
 */
Blockly.Folder.prototype.interpolateMsg = function(msg, var_args) {
    /**
...
Blockly.Folder.prototype.interpolateMsg.SPLIT_REGEX_ = /(%\d+|\n)/;
Blockly.Folder.prototype.interpolateMsg.INLINE_REGEX_ = /%1\s*$/;
 ...
 */
Blockly.Folder.prototype.moveInputBefore = function(name, refName) {
    if (name == refName) {
        return;
    }
    // Find both inputs.
 ...
 */
Blockly.Folder.prototype.moveNumberedInputBefore = function(
    inputIndex, refIndex) {
    // Validate arguments.
 ...
 */
Blockly.Folder.prototype.removeInput = function(name, opt_quiet) {
    for (var x = 0, input; input = this.inputList[x]; x++) {
        if (input.name == name) {
 ...
 */
Blockly.Folder.prototype.getInput = function(name) {
    for (var x = 0, input; input = this.inputList[x]; x++) {
        if (input.name == name) {
            return input;
        }
 ...
 * @param {string} name The name of the input.
 * @return {Blockly.Folder} The attached value block, or null if the input is
 *     either disconnected or if the input does not exist.
 */
Blockly.Folder.prototype.getInputTargetBlock = function(name) {
 ...
 */
Blockly.Folder.prototype.setMutator = function(mutator) {
 ...
 */
Blockly.Folder.prototype.getCommentText = function() {
    if (this.comment) {
 ...
 */
Blockly.Folder.prototype.setCommentText = function(text) {
 ...
 * @param {?string} text The text, or null to delete.
 */
Blockly.Folder.prototype.setWarningText = function(text) {
    if (this.isInFlyout) {
        text = null;
    }
    var changedState = false;
 ...
 * @param {?string} text The text, or null to delete.
 */
Blockly.Folder.prototype.setErrorIconText = function(text) {
 ...
 * @type {boolean}
 */
Blockly.Folder.isRenderingOn = true;
 ...
 */
Blockly.Folder.prototype.renderDown = function() {
    if (Blockly.Folder.isRenderingOn) {
        goog.asserts.assertObject(this.svg_,
