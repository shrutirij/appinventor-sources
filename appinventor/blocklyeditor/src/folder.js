/**
 * Folder.js is based on Block.js for the most part
 *
 * Look at what needs to be added from blockly.js -
 *      maybe all we need is to extend it, maybe we don't need to do anything
...
/**
 * @fileoverciew The class representing one folder
 * @author xlu2@wellesley.edu (Shirley Lu)
 */
'use strict';
...
/**
 * This is copied over from block.js - uncomment as needed
 */
 ...
 * @private
 */
Blockly.uidFolderCounter_ = 0;

/**
 * Get the Blockly.uidFolderCounter_
 * @returns {number}
 */
Blockly.getUidFolderCounter = function () {
    return Blockly.uidFolderCounter_;
};

/**
 * Set the Blockly.uidCounter_
 * @param {number} val, the value to set the countery to.
 */
Blockly.setUidFolderCounter = function (val) {
    Blockly.uidCounter = val;
};

/**
 * Generate a unique id. This is only locally unique at the moment.
 * Realtime collaboration mode - ????
 * @return {string}
 */
Blockly.genFolderUid = function() {
    var uid = (++Blockly.uidFolderCounter_).toString();
    //TODO[realtime]
...
/**
 * Class for one folder.
 * I believe it only needs to be an empty constructor
 * @constructor
 */
...
/**
 * Obtain a newly created folder.
 * Realtime functions not implemented
 * @param {!Blockly.Workspace} workspace The folder's workspace,
 *      the workspace the folder is on, not the one it refers to
 * @param prototypeName Name of the language object containing
 *      type-specific functions for this folder - what does this mean?
 * @returns {Blockly.Folder}
 */
...
/**
 * Initialization for one folder.
 * @param {!Blockly.Workspace} workspace The new folder's workspace
 * @param {?string} prototypeName Name of the language object containing
 *      type-specific functions for this folder.
 */
